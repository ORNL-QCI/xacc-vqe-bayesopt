...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        import pyxacc
        cmake_args = ['-DXACC_DIR='+os.path.dirname(os.path.realpath(pyxacc.__file__)),
		      '-DFROM_SETUP_PY=TRUE']
        args = sys.argv[1:]
...
s = setup(
    name='xacc-vqe-fcidump',
    version='0.1.0',
    author='Alex McCaskey',
    author_email='xacc-dev@eclipse.org',
    packages=find_packages('python'),
    package_dir={'xacc-vqe-fcidump':'python'},
    ...
    ext_modules=[CMakeExtension('pyxaccvqefcidump')],
